...
import logo from "./assets/img/icons/WhatsApp.png";
import "./App.css";
...
function App() {
  ...
  return (
    <div className="p-5">
      ...
      <div
        className="flex mt-5 p-4 mb-4 text-sm text-blue-700 bg-blue-100 rounded-lg dark:bg-blue-200 dark:text-blue-800"
        role="alert"
      >
        <svg
      ...
      <div
        className="flex p-4 text-sm text-gray-700 bg-gray-100 rounded-lg dark:bg-gray-700 dark:text-gray-300"
        role="alert"
      >
        <svg
          className="inline flex-shrink-0 mr-3 w-5 h-5"
